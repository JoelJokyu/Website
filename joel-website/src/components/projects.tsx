            ...
            <div className="p-4 md:p-6 flex flex-col grow">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                {project.tags.length > 3 && (
                  <span className="text-xs bg-white/5 text-white/70 px-2 md:px-3 py-1 rounded-full border border-white/10">
                    +{project.tags.length - 3}
                  </span>
                )}
              </div>
              ...
              <div className="flex gap-2 md:gap-3">
                ...
                >
                  <img src={ExternalLink} className="w-3 h-3 md:w-4 md:h-4" />
